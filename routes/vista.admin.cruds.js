                                            ...
                                            db.query(
                                                ...
                                                (err, result) => {
                                                    if (err) {
                                                        ...
                                                        req.flash(
                                                            "prof",
                                                            "Modificacion de datos correctamente"
                                                        );
                                                        res.redirect(
                                                            "/homeadmin"
                                                        );
                    ...
                    (err, rows) => {
                        if (err) {
                            ...
                            if (rows.length == 0) {
                                db.query(
                                    ...
                                    (err, result) => {
                                        if (err) {
                                            ...
                                            req.flash(
                                                "prof",
                                                "Agrego de materia al profesor de manera correcta"
                                            );
                                            res.redirect("/homeadmin");
                                        }
                                    }
                                ...
                                req.flash(
                                    "prof",
                                    "El profesor ya está registrado en esa materia"
                                );
                                res.redirect("/homeadmin");
                            }
                        }
                    ...
                    (err, rows) => {
                        if (err) {
                            ...
                            if (rows.length == 0) {
                                db.query(
                                    ...
                                    (err, result) => {
                                        if (err) {
                                            ...
                                            req.flash(
                                                "alumn",
                                                "Agrego de grupo al alumno de manera correcta"
                                            );
                                            res.redirect("/homeadmin");
                                        }
                                    }
                                ...
                                req.flash(
                                    "alumn",
                                    "Alumno ya agregado en el grupo"
                                );
                                res.redirect("/homeadmin");
                            }
                        }
