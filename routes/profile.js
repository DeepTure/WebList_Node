        ...
        if (validacioncon.aceptacion) {
            if (validacioncona.aceptacion) {
                if (contraseña == confirmar) {
                    ...
                    db.query(
                        "update profesor set contraseña=? where numEmpleado= ?",
                        [asegurado, numEmpleado],
                        (err, result) => {
                            if (err) {
                                console.log(err);
                            } else {
...
router.post(
    ...
    (req, res) => {
        ...
        if (validacioncor.aceptacion) {
            db.query(
                "update profesor set correo=? where numEmpleado= ?",
                [correo, numEmpleado],
                (err, result) => {
                    if (err) {
                        console.log(err);
...
router.post(
    ...
    (req, res) => {
        ...
        if (validacioncor.aceptacion) {
            db.query(
                "update alumno set correo=? where boleta= ?",
                [correo, boleta],
                (err, result) => {
                    if (err) {
                        console.log(err);
        ...
        if (validacioncon.aceptacion) {
            if (validacioncona.aceptacion) {
                if (contraseña == confirmar) {
                    ...
                    var asegurado = hash.digest("hex");
                    db.query(
                        "update administrador set contraseña=? where idAdmin= ?",
                        [asegurado, idAdmin],
                        (err, result) => {
                            if (err) {
                                console.log(err);
...
router.post(
    ...
    (req, res) => {
        ...
        if (validacioncor.aceptacion) {
            db.query(
                "update administrador set correo=? where idAdmin= ?",
                [correo, idAdmin],
                (err, result) => {
                    if (err) {
                        console.log(err);
...
router.post(
    ...
    (req, res) => {
        ...
        if (validacionnom.aceptacion) {
            db.query(
                "update administrador set nombre= ? where idAdmin= ?",
                [nombre, idAdmin],
                (err, result) => {
                    if (err) {
                        console.log(err);
